...
<div class="container-fluid">
	...
	<form action="" id="manage-patient">
		...
		<div class="form-group">
			...
			<textarea cols="30" rows="3" name="address" required class="form-control"><?php echo isset($meta['address']) ? $meta['address']: '' ?></textarea>
		</div>
		<div class="form-group">
			<label for="" class="control-label">Contact</label>
			<input type="text" name="contact" required class="form-control" value="<?php echo isset($meta['contact']) ? $meta['contact']: '' ?>">
		</div>
