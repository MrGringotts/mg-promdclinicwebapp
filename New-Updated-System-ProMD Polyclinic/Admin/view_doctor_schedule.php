...
<?php 
	...
	$qry = $conn->query("SELECT * FROM doctors_schedule where doctor_id=".$_GET['id']." GROUP BY day ORDER BY id ASC ");
?>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<th class="text-center"><?php echo date("h:i A",strtotime($row['f_time_frame'])).' - '.date("h:i A",strtotime($row['t_time_frame'])) ?></th>
					</tr>
					<?php endwhile; ?>
				</tbody>
			</table>
