...
$file = $_FILES['db_name']['name'];

$sql_file = "database/".$file."";
IMPORT_TABLES($dbhost,$dbuser,$dbpass,$dbname, $sql_file);
...
header('location:index.php?page=backup-restore&type=restore&status=1');
?>
